...
CORS_ORIGIN_WHITELIST = config(
    "CORS_ORIGIN_WHITELIST", default="http://127.0.0.1:8000", cast=Csv()
)
...
JAZZMIN_SETTINGS = {
    ...
    "site_title": "Crypto Tracker",
    # Title on the brand, and login screen (19 chars max) (defaults to current_admin_site.site_header if absent or None)
    "site_header": "Welcome to Crypto Tracker!",
...
BITGET_API_PASSPHRASE = config("BITGET_API_PASSPHRASE", "")
